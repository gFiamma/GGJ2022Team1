...
public class NPC : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Input.GetButtonDown("Interact") && canInteract && DialogueManager.isTyping == false)          //se premi il tasto per interagire, puoi interagire, l'NPC non sta parlando e non hai già interagito
        {
